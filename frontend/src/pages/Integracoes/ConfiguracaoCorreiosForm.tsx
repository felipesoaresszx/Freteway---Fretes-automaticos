...
export function ConfiguracaoCorreiosForm({ transportadora, onClose }: { transportadora: Transportadora; onClose: () => void }) {
  ...
  return <Card className="border-state-info/40">
    ...
    {loading ? <p className="text-sm text-text-secondary">Carregando...</p> : <form onSubmit={save} className="grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
      ...
      <Field label="Preço exibido"><Input readOnly value="Portal / balcão" className="cursor-not-allowed bg-surface2" /></Field>
